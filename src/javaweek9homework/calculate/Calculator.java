...
public class Calculator {
    public void addition(int a, int b) {            //instance method created
        int add = a + b;                            // integer variable assigned
        System.out.println("Addition is: " + add);  // print statement
    }

    public void subtraction(int a, int b) {             //instance method created
        int sub = a - b;                                //integer assigned
        System.out.println("Subtraction is: " + sub);
    }

    public void divition(int a, int b) {                //instance method created
        int div = a / b;
        System.out.println("Divition is: " + div);
    }

    public void multiplication(int a, int b) {          //instance method created
        int multi = a * b;
        System.out.println("Multiplication is: " + multi);
    }

    public void calculateResult(int a, int b, char c) {     //instance method created
        if (c == '+') {
            addition(a, b);
        } else if (c == '-') {
            subtraction(a, b);
            ...
            System.out.println("Please enter correct symbol.");  // user input message
        }
    }
